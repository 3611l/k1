...
int main(int argc, char ** argv) {
  ...
  while (active) {
    ...
    if (IsKeyDown(VK_F6) && recoil_level_key_F6_pressed == 0) // RECOIL LEVEL
    {
      ...
      case 1:
        recoil_level = 2;
        recoil_level_float = 0.20 f;
        break;
      case 2:
        recoil_level = 3;
        recoil_level_float = 0.30 f;
        break;
      case 3:
        recoil_level = 4;
        recoil_level_float = 0.40 f;
        break;
      case 4:
        recoil_level = 5;
        recoil_level_float = 0.50 f;
        break;
      case 5:
        recoil_level = 6;
        recoil_level_float = 0.60 f;
        break;
      case 6:
        recoil_level = 1;
        recoil_level_float = 0.10 f;
        break;
    ...
    if (IsKeyDown(VK_LEFT)) {
      if (max_dist > 100.0 f * 40.0 f)
        max_dist -= 50.0 f * 40.0 f; // move by 2,000f
    }

    if (IsKeyDown(VK_RIGHT)) {
      if (max_dist < 800.0 f * 40.0 f)
        max_dist += 50.0 f * 40.0 f; // move by 2,000f
    }
